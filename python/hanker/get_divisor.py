...
# divisor_list = PrimeFactorsListGenerator(1254000000)


def print_divisor_list(num_list):
    for num in num_list:
        divisor_list = PrimeFactorsListGenerator(num)
        print("{} ---> {}".format(num, divisor_list))


num_list = [1254000000, 999995, 834906]

print_divisor_list(num_list)
